...
class TOV:
  ...
  def __init__(self, en_arr, p_arr, add_crust=True, plot_eos=False):
    ...
    if(plot_eos):
      ...
      plt.plot([min(self.__en_arr / (MeV_fm3_to_pa_cgs / c**2)), max(self.__en_arr / (MeV_fm3_to_pa_cgs / c**2))],
                [min(self.__en_arr / (MeV_fm3_to_pa_cgs / c**2)), max(self.__en_arr / (MeV_fm3_to_pa_cgs / c**2))],
                color='gray',linestyle='--',label='stiffest eos')
